                                    ...
                                    <tbody>
                                        @foreach ($accountList as $acc)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="display:block;">{{ $acc->account_name }}</td>
                                    ...
                                    <tbody>
                                        @foreach ($groupList as $grp)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="display:block;">{{ $grp->group_name }}</td>
                                                <td class="text-center" style="">{{ $grp->description }}</td>
                                        ...
                                        @foreach ($bankAccount as $bank)
                                            <tr>
                                                <td style="display:block;"><img
                                                        ...
                                                        style="height: 30px; width: 90px; border-radius:0%;"></td>
