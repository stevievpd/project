                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex w-100">
                                    <div class="col-1 " style="text-align: center">Date</div>
                                    <div class="col-2 " style="text-align: center">Code</div>
                                    <div class="col-3 " style="text-align: center">Description</div>
                                    <div class="col-2 " style="text-align: center">Debit</div>
                                    <div class="col-2 " style="text-align: center">Credit</div>
                                    <div class="col-2 " style="text-align: center">Balance</div>
                                </div>
                            </th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex w-100 fgh">
                                        ...
                                        <div class="col-2 border-top text-end p-1 text-dark bg-opacity-10">
                                            <b><?php echo '₱ ' . number_format((float) $totaldeb, 2); ?></b>
                                        </div>
                                        <div class="col-2 border-top text-end p-1 text-dark bg-opacity-10">
                                            <b><?php echo '₱ ' . number_format((float) $totalcred, 2); ?></b>
                                        </div>
                                        <div class="col-2 py-2 border-top text-end p-2 text-dark bg-opacity-10">
                                            <?php
