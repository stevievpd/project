        ...
        <div id="content" class="" style="width: 80%; margin:auto;">
            ...
            <div class="row" style="">
                ...
                <div class="row align-items-start shadow p-3 mb-5 bg-body rounded">
                    ...
                    <div class="col-4 containEmp border border-rounded sh" style="height:32.6vh;">
                        <div class="row emp">
                            <div
                ...
                <div class="row align-items-start employee ">
                    <div class="col-7 col-md-offset-1 shadow p-3 mb-5 bg-body rounded employeList">
                        <div class="text-center titleHead  rounded">
                    ...
                    <div class="col-4 containEmp shadow  ms-5 bg-body rounded graphBox">
                        <div class="text-center titleHead rounded">
